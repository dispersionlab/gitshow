...
function isHeading(type) {
    return [BLOCKS.HEADING_1, BLOCKS.HEADING_2, BLOCKS.HEADING_3, BLOCKS.HEADING_4, BLOCKS.HEADING_5, BLOCKS.HEADING_6].includes(type);
}
...
function isList(type) {
    return [BLOCKS.UL_LIST, BLOCKS.OL_LIST].includes(type);
}
